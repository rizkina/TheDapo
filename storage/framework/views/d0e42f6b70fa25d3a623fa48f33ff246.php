...
<body class="bg-slate-50 text-slate-900 antialiased dark:bg-slate-950 dark:text-white">
    ...
    <nav class="fixed top-0 z-50 w-full border-b border-slate-200 bg-white/80 backdrop-blur-md dark:border-slate-800 dark:bg-slate-950/80">
        <div class="mx-auto flex max-w-7xl items-center justify-between p-4 lg:px-8">
            ...
            <div>
                <a href="<?php echo e(url('/app/login')); ?>" class="rounded-full bg-indigo-600 px-6 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600 transition-all">
                    Masuk ke Sistem
                </a>
            </div>
        </div>
        ...
        <div class="mx-auto max-w-7xl px-6 lg:px-8">
            <div class="mx-auto max-w-2xl text-center">
                ...
                <div class="mt-10 flex items-center justify-center gap-x-6">
                    <a href="<?php echo e(url('/app/login')); ?>" class="rounded-xl bg-indigo-600 px-8 py-4 text-lg font-bold text-white shadow-xl hover:bg-indigo-500 hover:-translate-y-1 transition-all">
                        Mulai Sekarang
                    </a>
                </div>
            </div>
        ...
        <div class="mx-auto max-w-7xl px-6 lg:px-8">
            <dl class="grid grid-cols-1 gap-x-8 gap-y-16 text-center lg:grid-cols-3">
                <div class="mx-auto flex max-w-xs flex-col gap-y-4">
                    ...
                    <dd class="order-first text-5xl font-extrabold tracking-tight text-indigo-600 sm:text-6xl"><?php echo e(number_format($totalSiswa)); ?></dd>
                </div>
                <div class="mx-auto flex max-w-xs flex-col gap-y-4">
                    <dt class="text-base leading-7 text-slate-600 dark:text-slate-400 font-semibold uppercase tracking-widest">Guru & Tendik</dt>
                    <dd class="order-first text-5xl font-extrabold tracking-tight text-indigo-600 sm:text-6xl"><?php echo e(number_format($totalPtk)); ?></dd>
                </div>
                <div class="mx-auto flex max-w-xs flex-col gap-y-4">
                    ...
                    <dd class="order-first text-5xl font-extrabold tracking-tight text-indigo-600 sm:text-6xl"><?php echo e(number_format($totalRombel)); ?></dd>
                </div>
            </dl>
        </div>
    </section>
...
</html><?php /**PATH /var/www/resources/views/landing.blade.php ENDPATH**/ ?>